...
Version  : 19.04.3
Release  : 11
URL      : https://download.kde.org/stable/applications/19.04.3/src/kiriki-19.04.3.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.3/src/kiriki-19.04.3.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.3/src/kiriki-19.04.3.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562872802
mkdir -p clr-build
pushd clr-build
