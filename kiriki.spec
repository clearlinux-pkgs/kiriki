...
Source0  : https://download.kde.org/stable/applications/18.08.0/src/kiriki-18.08.0.tar.xz
Source99 : https://download.kde.org/stable/applications/18.08.0/src/kiriki-18.08.0.tar.xz.sig
Summary  : No detailed summary available
Group    : Development/Tools
License  : GFDL-1.2 GPL-2.0
Requires: kiriki-bin
Requires: kiriki-data
Requires: kiriki-license
Requires: kiriki-locales
...
export LANG=C
export SOURCE_DATE_EPOCH=1535229929
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1535229929
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/kiriki
cp COPYING %{buildroot}/usr/share/doc/kiriki/COPYING
cp COPYING.DOC %{buildroot}/usr/share/doc/kiriki/COPYING.DOC
pushd clr-build
%make_install
popd
%find_lang kiriki
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/kiriki/COPYING
/usr/share/doc/kiriki/COPYING.DOC
