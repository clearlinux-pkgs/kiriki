...
Version  : 24.02.0
Release  : 25
URL      : https://download.kde.org/stable/release-service/24.02.0/src/kiriki-24.02.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/kiriki-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/kiriki-24.02.0.tar.xz.sig
...
%prep
%setup -q -n kiriki-24.02.0
cd %{_builddir}/kiriki-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710532588
mkdir -p clr-build
pushd clr-build
