...
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/kiriki-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/kiriki-24.08.1.tar.xz.sig
...
%setup -q -n kiriki-24.08.1
cd %{_builddir}/kiriki-24.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726255395
mkdir -p clr-build
pushd clr-build
