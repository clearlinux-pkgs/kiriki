...
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/kiriki-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/kiriki-25.04.2.tar.xz.sig
...
%setup -q -n kiriki-25.04.2
cd %{_builddir}/kiriki-25.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749529677
mkdir -p clr-build
pushd clr-build
