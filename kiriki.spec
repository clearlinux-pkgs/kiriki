...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kiriki-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kiriki-24.12.3.tar.xz.sig
...
%setup -q -n kiriki-24.12.3
cd %{_builddir}/kiriki-24.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742534968
mkdir -p clr-build
pushd clr-build
