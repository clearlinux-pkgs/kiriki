...
Version  : 25.04.1
Release  : 43
URL      : https://download.kde.org/stable/release-service/25.04.1/src/kiriki-25.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/kiriki-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/kiriki-25.04.1.tar.xz.sig
...
%setup -q -n kiriki-25.04.1
cd %{_builddir}/kiriki-25.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747201288
mkdir -p clr-build
pushd clr-build
...
/usr/share/doc/HTML/sl/kiriki/index.cache.bz2
/usr/share/doc/HTML/sl/kiriki/index.docbook
