...
Version  : 24.08.2
Release  : 36
URL      : https://download.kde.org/stable/release-service/24.08.2/src/kiriki-24.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.2/src/kiriki-24.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.2/src/kiriki-24.08.2.tar.xz.sig
...
%setup -q -n kiriki-24.08.2
cd %{_builddir}/kiriki-24.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728778300
mkdir -p clr-build
pushd clr-build
